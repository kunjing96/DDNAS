...
class ReLUConvBN(nn.Module):
  ...
  def reset_parameters(self):
    self.op[1].reset_parameters()
    self.op[2].reset_running_stats()
    self.op[2].reset_parameters()
...
class SepConv(nn.Module):
  ...
  def reset_parameters(self):
    self.op[1].reset_parameters()
    self.op[2].reset_parameters()
    self.op[3].reset_running_stats()
    self.op[3].reset_parameters()
...
class DualSepConv(nn.Module):
  ...
  def reset_parameters(self):
    self.op_a.reset_parameters()
    self.op_b.reset_parameters()
...
class POOLING(nn.Module):
  ...
  def reset_parameters(self):
    if self.preprocess: self.preprocess.reset_parameters()
